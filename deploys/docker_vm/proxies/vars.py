...
oidc_clients = [
    ...
    },
    {
        ...
        "policy": "two_factor",
        "redirect_uris": ["https://books.dv.zone/oauth2-callback"],
        "scopes": ["openid", "groups", "email", "profile"],
        "auth_method": "client_secret_post",
        "claims_policy": "default",
    },
    ...
    },
    {
        "id": "homepage",
        "name": "Homepage",
        "secret_hash": "$pbkdf2-sha512$310000$9v4/55yztlYKAYCwdq5Vyg$y9Fn5qGs1XjfuMZCB.DzqvaBWAEjGVCh96BKqFpL5PEClh5lpz9pli/8GcIPqR4QqZfiuvQuZjYIkptTokagwg",
        "policy": "two_factor",
        "redirect_uris": ["https://home.dv.zone/api/auth/callback/homepage-oidc"],
        "scopes": ["openid", "groups", "email", "profile"],
        "auth_method": "client_secret_basic",
        "claims_policy": "default",
    },
