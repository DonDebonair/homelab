...
apps = [
    ...
    ComposeApp(
        ...
        # jump -- migrations are cumulative and 16.0.2 ships the fixed migrations.
    ...
    ComposeApp(
        ...
        # Container tags drop the `v` that the git releases use (git v2.6.0 -> image
        # 2.6.0); `v2.6.0` is a "manifest unknown" pull error.
        version="2.6.0",
