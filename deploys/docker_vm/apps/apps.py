...
apps = [
    ...
    ComposeApp(
        ...
        # jump -- migrations are cumulative and 16.0.5 ships the fixed migrations.
    ...
    ComposeApp(
        ...
        # Container tags drop the `v` that the git releases use (git v2.10.0 -> image
        # 2.10.0); `v2.10.0` is a "manifest unknown" pull error.
        version="2.10.0",
